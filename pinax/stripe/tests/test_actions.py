...
class SyncsTests(TestCase):
    ...
    def test_sync_coupon_from_stripe_data(self):
        ...
        self.assertEqual(c1, cs1)
        self.assertEqual(c1.percent_off, decimal.Decimal(35.00))
        ...
        self.assertEqual(c2, cs2)
        self.assertEqual(c2.percent_off, decimal.Decimal(35.00))
    ...
    def test_sync_subscription_from_stripe_data(self):
        ...
        self.assertEqual(d.coupon.percent_off, decimal.Decimal(35.00))
    ...
    def test_sync_subscription_from_stripe_data_updated(self):
        ...
        self.assertEqual(s.discount.coupon.stripe_id, "35OFF")
